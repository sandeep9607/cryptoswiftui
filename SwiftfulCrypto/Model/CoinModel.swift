...
//  SwiftfulCrypto
//
//  Created by Sandeep Maurya on 04/04/24.
//
...
struct CoinModel: Identifiable, Codable {
    ...
    let high24H, low24H, priceChange24H, priceChangePercentage24H: Decimal?
    let marketCapChange24H, marketCapChangePercentage24H: Decimal?
    ...
    func updateHoldings(amount: Decimal) -> CoinModel {
    ...
    var currentHoldingValue: Decimal{
